...
const { data: list, pending } = await useLazyAsyncData("services", () =>
  $fetch(
    `${config.public.apiUrlAfl}/api/api.php/records/services?filter=pub,eq,1`,
    {
      headers: {
